...
fast: fast_man_set fast_alpha_blending fast_parse_bmp fast_calloc fast_man_set
...
debug_alpha_blending_AVX: debug_calloc
	g++ -c $(DEBUG_FLAGS) $(AVX_512_FLAGS) Src/Libs/AlphaBlendingAVX/AlphaBlendingAVX.cpp Obj/AlignedCalloc.o -o Obj/AlphaBlendingAVX.o
